        ...
        <table className="users-table">
            ...
            {restaurants.map(restaurant => (
                <tr key={restaurant.id}>
                    ...
                    <td>
                        <button onClick={() => navigateToEditRestaurant(restaurant.id)} className="button-edit" style={styles.buttone}>РЕДАКТИРОВАТЬ</button>
                        <button onClick={() => deleteRestaurant(restaurant.id)} className="button-delete"style={{ background: 'salmon', color: 'white'}}>УДАЛИТЬ</button>
                    </td>
                </tr>
            ))}
            </tbody>
