    ...
    <table className="users-table">
            ...
            {countries.map(country => (
                <tr key={country.countryId}>
                    ...
                    <td>{country.name}</td>
                    <td>
                        <button onClick={() => navigateToEditCountry(country.countryId)} className="button-edit" style={styles.buttone}>РЕДАКТИРОВАТЬ</button>
                        <button onClick={() => deleteCountry(country.countryId)} className="button-delete"style={{ background: 'salmon', color: 'white'}}>УДАЛИТЬ</button>
                    </td>
                </tr>
            ))}
            </tbody>
