    ...
    <table className="users-table">
            ...
            {locations.map(location => (
                <tr key={location.locationId}>
                    ...
                    <td>
                        <button onClick={() => navigateToEditLocation(location.locationId)} className="button-edit" style={styles.buttone}>РЕДАКТИРОВАТЬ</button>
                        <button onClick={() => deleteLocation(location.locationId)} className="button-delete"style={{ background: 'salmon', color: 'white'}}>УДАЛИТЬ</button>
                    </td>
                </tr>
            ))}
            </tbody>
