        ...
        <div className="admin-panel"style={{ paddingTop: '50px',paddingBottom: '250px'}}>
            ...
            {cities.map(city => (
                <tr key={city.cityId}>
                    ...
                    <td>
                        <button onClick={() => navigateToEditCity(city.cityId)} className="button-edit" style={styles.buttone}>РЕДАКТИРОВАТЬ</button>
                        <button onClick={() => deleteCity(city.cityId)} className="button-delete"style={{ background: 'salmon', color: 'white'}}>УДАЛИТЬ</button>
                    </td>
                </tr>
            ))}
            </tbody>
