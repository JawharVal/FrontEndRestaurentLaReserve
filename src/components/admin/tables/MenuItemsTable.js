        ...
        <table className="users-table">
            ...
            {menuItems.map(menuItem => (
                <tr key={menuItem.id}>
                    ...
                    <td>
                        <button onClick={() => navigateToEditMenuItem(menuItem.id)} className="button-edit" style={styles.buttone}>РЕДАКТИРОВАТЬ</button>
                        <button onClick={() => deleteMenuItem(menuItem.id)} className="button-delete"style={{ background: 'salmon', color: 'white'}}>УДАЛИТЬ</button>
                    </td>
                </tr>
            ))}
            </tbody>
